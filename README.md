...
**광고는 켜져 있습니다.** 게시자 ID `ca-pub-8694678185722423`, 광고 단위 `5518200303`.

세 자리가 **같은 광고 단위 하나**를 씁니다. Google이 허용하는 사용법이지만 보고서에서 좌·우·하단 실적이 한 덩어리로 합쳐집니다. 자리별로 나눠 보려면 단위를 2개 더 만들어 `data-ad-slot`을 갈아끼우면 됩니다.
